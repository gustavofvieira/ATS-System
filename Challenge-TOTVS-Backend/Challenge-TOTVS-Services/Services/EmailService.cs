using Challenge.TOTVS.Domain.Enums;
...
namespace Challenge.TOTVS.Services.Services
{
    public class EmailService : IEmailService
    {
        ...
        public void SendRecovery(User user, Guid recoverId)
        {
            ...
            var htmlBody = CreateBodyTemplate(user.Name, TemplateEmail.RecoverPassword, $"{_frontService.Host}{_frontService.UpdatePassword}?codeRecover={recoverId}");
            var mail = new Mail
            {
